...
{
	void SendSimpleCustomEvent(string eventName, string key, object value) {
		Dictionary<string, object> payloadData = new Dictionary<string, object> ();
		payloadData.Add (key, value);

		Analytics.CustomEvent (eventName, payloadData);
	}
...
//
	...
	{
		SendSimpleCustomEvent ("Pickup object", "total_picked_up", 10);
