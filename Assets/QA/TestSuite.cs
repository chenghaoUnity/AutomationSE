...
{
	[CDTest(Assert.AreEquals, "|Standard Event| Verify SDK Version Number", "20660", "1.0.1")]
	...
	[CDTest(Assert.AreEquals, "|Standard Event| Verify chat_message_sent Event Status", "20866", "Ok", "TooManyRequests")]
	[CDTest(Assert.EventPayload, "chat_message_sent", "20866", new string[]{})]
	public string chat_message_sent()
	{
	...
	[CDTest(Assert.EventPayload, "social_share_accept", "20871", "share_type", "invite", "social_network", "sina_weibo")]
