...
namespace UnityEngine.Analytics.Experimental
{
    ...
    /// </remarks>
    [Serializable, CreateAssetMenu(fileName = "ItemAcquiredPayload.asset", menuName = "Analytics Payloads/Monetization/Item Acquired")]
    public class ItemAcquiredPayload : AnalyticsEventPayload
    {
        ...
        protected override void ValidateDataField (string key, object value)
        {
            ...
            if (key == k_ParamKey_Name || key == k_ParamKey_ResourceType || key == k_ParamKey_Source)
            {
