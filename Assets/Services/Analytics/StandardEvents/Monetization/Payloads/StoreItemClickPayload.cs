...
namespace UnityEngine.Analytics.Experimental
{
    ...
    /// </remarks>
    [Serializable, CreateAssetMenu(fileName = "StoreItemClickPayload.asset", menuName = "Analytics Payloads/Monetization/Store Item Click")]
    public class StoreItemClickPayload : AnalyticsEventPayload
    {
        ...
        protected override void ValidateDataField (string key, object value)
        {
            ...
            if (key == k_ParamKey_ItemId || key == k_ParamKey_ItemName || key == k_ParamKey_StoreType)
            {
