...
namespace UnityEngine.Analytics.Experimental
{
    ...
    /// </remarks>
    [Serializable, CreateAssetMenu(fileName = "ConsumableAcquiredPayload.asset", menuName = "Analytics Payloads/Monetization/Consumable Acquired")]
    public class ConsumableAcquiredPayload : AnalyticsEventPayload
    {
        ...
        protected override void ValidateDataField (string key, object value)
        {
            ...
            if (key == k_ParamKey_Name || key == k_ParamKey_Source)
            {
