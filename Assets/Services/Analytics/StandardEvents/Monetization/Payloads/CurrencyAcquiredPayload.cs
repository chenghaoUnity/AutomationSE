...
namespace UnityEngine.Analytics.Experimental
{
    ...
    /// </remarks>
    [Serializable, CreateAssetMenu(fileName = "CurrencyAcquiredPayload.asset", menuName = "Analytics Payloads/Monetization/Currency Acquired")]
    public class CurrencyAcquiredPayload : AnalyticsEventPayload
    {
        ...
        protected override void ValidateDataField (string key, object value)
        {
            ...
            if (key == k_ParamKey_Name || key == k_ParamKey_PurchaseId || key == k_ParamKey_PurchaseName || key == k_ParamKey_Source)
            {
