...
{
    /// <summary>
    /// Base standard event class from which game progression payload classes derive.
    /// </summary>
    public abstract class GamePayload : AnalyticsEventPayload
    {
        ...
        /// </summary>
        /// <returns>The new instance of payload type <c>T</c>, where <c>T</c> inherits from <see cref="GamePayload"/>.</returns>
