...
{
    /// <summary>
    /// Base class for all game payloads.
    /// </summary>
    public abstract class GamePayload : AnalyticsEventPayload
    {
        ...
        /// <summary>
        /// Creates an instance of the base GamePayload class, adding levelIndex to eventData. If eventData is null, creates the dictionary.
        /// </summary>
        ...
        /// <typeparam name="T">The payload type that inherits from GamePayload.</typeparam>
        protected static T CreateInstance<T> (int levelIndex, IDictionary<string, object> eventData) where T : GamePayload
        {
            if (eventData == null)
            {
        ...
        /// <summary>
        /// Creates an instance of the base GamePayload class, adding levelName to eventData. If eventData is null, creates the dictionary.
        /// </summary>
        /// <returns>The instance of LevelPayload.</returns>
        /// <param name="levelName">The name of the level.</param>
        /// <param name="eventData">Dictionary with any custom parameters.</param>
        /// <typeparam name="T">The payload type that inherits from GamePayload.</typeparam>
        protected static T CreateInstance<T> (string levelName, IDictionary<string, object> eventData) where T : GamePayload
        {
            if (eventData == null)
            {
                eventData = new Dictionary<string, object>();
        ...
        /// <summary>
        /// Creates an instance of the base GamePayload class, adding levelName and levelIndex to eventData. If eventData is null, creates the dictionary.
        /// </summary>
        /// <returns>The instance of LevelPayload.</returns>
        /// <param name="levelIndex">The index of the level.</param>
        /// <param name="levelName">The name of the level.</param>
        /// <param name="eventData">Dictionary with any custom parameters.</param>
        /// <typeparam name="T">The payload type that inherits from GamePayload.</typeparam>
        protected static T CreateInstance<T> (int levelIndex, string levelName, IDictionary<string, object> eventData) where T : GamePayload
        {
            if (eventData == null)
            {
                eventData = new Dictionary<string, object>();
