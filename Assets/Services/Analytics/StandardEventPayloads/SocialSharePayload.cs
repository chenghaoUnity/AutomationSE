...
{
    [Serializable]
    [CreateAssetMenu(fileName = "SocialSharePayload.asset", menuName = "Analytics Events/Social Share")]
    public class SocialSharePayload : AnalyticsEventPayload
    {
        ...
        new public static SocialSharePayload CreateInstance (string messageId)
        {
            return CreateInstance(messageId, new Dictionary<string, object>());
        }

        new public static SocialSharePayload CreateInstance (string messageId, IDictionary<string, object> eventParams)
        {
            eventParams.Add(k_ParamKey_MessageId, messageId);
            return CreateInstance<SocialSharePayload>(eventParams);
        }
    }
}
