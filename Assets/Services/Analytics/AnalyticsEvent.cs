...
namespace UnityEngine.Analytics.Experimental
{
	...
	{
		static readonly string k_SdkVersion = "0.2.0";

		static readonly string k_ErrorFormat_RequiredParamNotSet = "Required param not set ({0}).";

		static readonly string[] k_StandardEventNames =
		{
			"achievement_step",
        ...
        {
			return AdComplete(rewarded, advertisingNetwork.ToString(), placementId, eventData);
        }
        ...
        {
			return AdOffer(rewarded, advertisingNetwork.ToString(), placementId, eventData);
        }
        ...
        {
			return AdSkip(rewarded, advertisingNetwork.ToString(), placementId, eventData);
        }
        ...
        {
			return AdStart(rewarded, advertisingNetwork.ToString(), placementId, eventData);
        }
        ...
        public static AnalyticsResult LevelUp (string oldLevelName, string newLevelName, IDictionary<string, object> eventData = null)
        {
			...
			{
				OnValidationFailed(string.Format(k_ErrorFormat_RequiredParamNotSet, "old_level_name"));
			}
			else
			{
				m_EventData.Add("old_level_name", oldLevelName);
			}
        ...
        public static AnalyticsResult LevelUp (int oldLevelIndex, int newLevelIndex, IDictionary<string, object> eventData = null)
        {
			...
			m_EventData.Add("old_level_index", oldLevelIndex);
        ...
        public static AnalyticsResult PostAdAction (bool rewarded, AdvertisingNetwork advertisingNetwork, string placementId = null, IDictionary<string, object> eventData = null)
        {
			...
			m_EventData.Add("rewarded", rewarded);
			m_EventData.Add("network", advertisingNetwork.ToString());
			if (!string.IsNullOrEmpty(placementId))
			{
				m_EventData.Add("placement_id", placementId);
			}
        ...
        public static AnalyticsResult ScreenVisit (ScreenName screenName, IDictionary<string, object> eventData = null)
        {
			...
			m_EventData.Add("screen_name", SplitCamelCase(screenName.ToString()));
		...
		public static AnalyticsResult SocialShare (ShareType shareType, SocialNetwork socialNetwork, string senderId = null, string recipientId = null, IDictionary<string, object> eventData = null)
        {
			...
			m_EventData.Add("share_type", SplitCamelCase(shareType.ToString()));
			m_EventData.Add("social_network", socialNetwork.ToString());
        ...
        public static AnalyticsResult StoreItemClick (StoreType storeType, string itemId, string itemName = null, Dictionary<string, object> eventData = null)
        {
			...
			m_EventData.Add("type", SplitCamelCase(storeType.ToString()));
        ...
        public static AnalyticsResult UserSignup (AuthorizationNetwork authorizationNetwork, IDictionary<string, object> eventData = null)
        {
			...
			m_EventData.Add("authorization_network", authorizationNetwork.ToString());
